    ...
    : QObject(parent)
{
    const QVector<User> users = {
            ...
            {"u005", "不会演戏（许仙版）", "许仙", ":/resources/avatar/4.jpg", Offline, "不碍事的白姑娘", false, "g002", "同学", ""},
            {"u006", "TralaleroTralala", "", ":/resources/avatar/2.jpg", Online, "不穿Nike（蓝勾版）", false, "g002", "同学", "广州"},
            {"u007", "圆头耄耋", "", ":/resources/avatar/6.jpg", Offline, "这只猫很懒，什么都没留下来", false, "g003", "服务器伙伴", ""},
            {"u008", "歪比巴卜", "指令哥", ":/resources/avatar/7.jpg", Mining, "歪比歪比", false, "g003", "服务器伙伴", "深圳"},
            ...
            {"u010", "BombardinoCrocodilo", "", ":/resources/avatar/9.jpg", Flying, "已塌房", false, "g003", "服务器伙伴", "成都"},
            {"u011", "momo", "临时 momo", ":/resources/avatar/10.jpg", Online, "今天也要准时上线", false, "g004", "临时会话", ""},
            {"u012", "blazer", "", ":/resources/avatar/0.jpg", Offline, "刷怪塔维护中", false, "g004", "临时会话", "武汉"},
            {"u013", "不吃香菜（考研版）", "", ":/resources/avatar/3.jpg", Mining, "背书到下界", false, "g004", "临时会话", ""},
            {"u014", "歪比巴卜", "", ":/resources/avatar/7.jpg", Online, "收到请回复", false, "g005", "最近添加", "南京"},
            {"u015", "圆头耄耋", "新好友", ":/resources/avatar/6.jpg", Flying, "刚刚通过好友验证", false, "g005", "最近添加", ""},
            {"u016", "TralaleroTralala", "", ":/resources/avatar/2.jpg", Offline, "晚点再聊", false, "g005", "最近添加", "重庆"},
    };
